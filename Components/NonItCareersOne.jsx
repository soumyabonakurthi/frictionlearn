...
function NonItCareersOne () {
    ...
    <div className="bg-white p-4 border-r border-0 border-orange-500">
      ...
      <ul className="list-none text-[#1D2228] ">
        ...
        <li className="mb-2 text-[22px] font-medium font-Lato font-sans "> Mechanical Engineering</li>
          <li className="mb-2 text-[22px] font-medium font-Lato font-sans text-[#F27329] "> Civil Engineering</li>
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    Start Your Skill-Building Path with
      <span className="text-[#F27329]">   Civil Engineering Course</span>
    </h2>
    <div className="bg-white p-2">
      ...
      Civil Engineering involves planning, designing, constructing, and maintaining infrastructure projects and systems.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Introduction to Civil Engineering</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Overview of civil engineering principles and their practical applications.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Structural Engineering</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Designing and analyzing structures to ensure stability and safety.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Geotechnical Engineering</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Studying soil and rock behavior for construction and foundation design.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Transportation Engineering</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Planning and designing efficient transportation systems and infrastructure.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Environmental Engineering</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Addressing environmental challenges and developing sustainable solutions.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Water Resources Engineering</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Managing and utilizing water resources effectively for various purposes.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Construction Management</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Surveying and Mapping</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Techniques for measuring and mapping land for construction projects.
            </p>
          </div>
        </div>
      </div>
...
export default NonItCareersOne;
