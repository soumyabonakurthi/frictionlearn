...
export default function CompetitiveExamsBank() {
  return (
  ...
  <div className="w-1/4 pr-4 mt-[70px]">
    <div className="bg-white p-4 border-r border-0 border-orange-500">
     ...
     <li className="mb-2 text-[16px] font-medium font-Lato font-sans  border-b-2 w-[180px] border-black ">RBI Grade-B</li>
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    <div className="bg-white p-2">
      ...
      RBI Grade-B preparation course equips you with knowledge for banking examination success.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Introduction to RBI and Banking Sector</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Understand RBI's role, functions, and the banking industry's framework.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Economic and Social Issues</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Explore current economic policies, social issues, and their impact on banking.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            ...
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Master mathematical concepts and problem-solving skills required for the exam.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            ...
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Develop logical reasoning skills for tackling complex problems and puzzles.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            ...
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Stay updated with current affairs, banking awareness, and financial news.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">English Language Proficiency</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Improve comprehension, grammar, and writing skills for effective communication
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Descriptive Writing and Essay</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Practice crafting essays and descriptive answers to express ideas clearly.
            </p>
          </div>
        </div> 
