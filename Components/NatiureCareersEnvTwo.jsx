...
export default function NatureCareers () {
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    <div className="bg-white p-2">
      ...
      Renewable Energy focuses on sustainable power sources to reduce reliance on fossil fuels.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Solar Power</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Harnessing energy from the sun using photovoltaic cells and solar panels.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Wind Energy</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Generating electricity through wind turbines in various environments.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Hydropower</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Utilizing water flow to produce electricity in dams and rivers.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Biomass Energy</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Converting organic materials into usable energy sources.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Geothermal Energy</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Exploiting heat from beneath the Earth's surface for power and heating.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Wave and Tidal Energy</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Capturing energy from ocean waves and tidal movements.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Renewable Integration</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Combining multiple renewable sources for a stable and efficient energy system
            </p>
          </div>
        </div>
