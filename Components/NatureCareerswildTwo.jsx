...
export default function NatureCareerswildTwo() {
  return (
  ...
  <div className="w-1/4 pr-4 mt-[70px]">
    <div className="bg-white p-4 border-r border-0 border-orange-500">
     ...
     <li className="mb-2 text-[16px] font-medium font-Lato font-sans  ">Wildlife Management</li>
   <li className="mb-2 text-[16px] font-medium font-Lato font-sans  border-b-2 w-[180px] border-black">Ecotourism</li>
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    <div className="bg-white p-2">
      ...
      Ecotourism explores sustainable travel practices and conservation benefits for natural areas.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Introduction to Ecotourism</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Understand ecotourism principles, its importance, and global impact on conservation.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Sustainable Travel Practices</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Learn how to travel responsibly while minimizing environmental and cultural impacts.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Conservation Strategies</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Explore methods for protecting ecosystems and wildlife through tourism.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Ecotourism and Local Communities</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Examine how ecotourism benefits and engages local communities economically and culturally.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Ecotourism Planning and Development</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Gain skills to plan, develop, and manage successful ecotourism projects.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Wildlife Observation Ethics</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Learn ethical guidelines for observing wildlife without disturbing their natural behavior.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Impact Assessment and Monitoring</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Discover techniques for assessing and monitoring the environmental impacts of tourism.
            </p>
          </div>
        </div> 
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Case Studies in Ecotourism</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Review real-world examples of successful and challenging ecotourism initiatives globally.
            </p>
          </div>
        </div> 
      </div>
