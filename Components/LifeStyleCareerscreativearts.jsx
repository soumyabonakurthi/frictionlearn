...
export default function LifeStyleCareerscreativearts() {
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    <div className="bg-white p-2">
      ...
      Master the art of capturing and telling stories through stunning images.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Camera Fundamentals</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Grasp camera basics, control exposure, capture light.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Composition and Storytelling</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Create visually appealing, meaningful images.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Lighting Techniques</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Master natural and artificial light, shape images.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Post-Processing</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Enhance images, correct flaws, achieve desired style.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Portrait Photography</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Connect with subjects, capture personality, create timeless portraits.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Landscape Photography</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Capture nature's beauty, balance elements, evoke emotions.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Photography Business</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Build a brand, market yourself, manage clients.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Different Photography Genres</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Diffe: Explore diverse styles, find your passion.
            </p>
          </div>
        </div>
