...
import frictionlogo from '../assets/logo.png';
...
const slides = [
  ...
  {
    backgroundImage: "url('../src/assets/image 39.png')",
...
<div className="w-[full] ">
  ...
  >
    <nav className="flex justify-between items-center h-[95px] p-6 ml-[104px] mr-[104px]">
      {/* Element hidden on small screens and shown on screens 390px and wider */}
      <div className=" items-center bg-[#FFFFFF] rounded-md w-[157px] h-[64px] opacity-75 mr-[20px] ml-[-30px]">
  <img src={frictionlogo} alt="Friction Logo" className="w-[133px] h-[53px] ml-[8px] mr-[16px]" />
</div>
