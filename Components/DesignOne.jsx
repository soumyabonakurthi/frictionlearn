      ...
      <div className="flex w-[full] mt-[58px] ml-[56px]">
        ...
        <div className="w-1/4 pr-4 mt-[70px]">
          <div className="bg-white p-4  border-r border-0 border-orange-500">
            ...
            <ul className="list-none text-[#1D2228] pl-4">
              ...
              <li className=" mb-2 text-[16px] font-medium font-Lato font-sans  border-b-2 w-[120px] border-black">Game Design</li>
        ...
        <div className="w-3/4 pl-2 mt-[76px]">
          ...
          <div className="bg-white p-2">
            <h3 className="text-[20px] font-semibold font-Lato font-sans text-[#1D2228] mt-[24px]">Game Design</h3>
            ...
            <div className="grid grid-cols-3 gap-[32px]">
              ...
              <div className="w-full ">
               ...
               <div  className='ml-[10px]'> 
                  <p className="text-[#1D2228]  font-bold text-[16px] font-Lato font-sans mb-2"> Introduction to Game Design </p>
               <p  className='text-[14px] font-Regular font-Lato font-sans mb-2'>Overview of game design principles,<br></br> industry trends, and key concepts..</p></div>
              ...
              <div className="w-full ">
               ...
               <div  className='ml-[10px]'>   <p className="text-[#1D2228]  font-bold text-[16px] font-Lato font-sans mb-2">UGame Mechanics and Dynamics</p>
               <p  className='text-[14px] font-Regular font-Lato font-sans mb-2'>Core mechanics, dynamics, and rules that<br></br> define gameplay experience..</p></div>
               
              </div>
              <div className="w-full ">
                <div>  <img src={development} alt="Mobile Development" className="w-[284px] h-[181px] rounded-sm mb-2"/>
                </div>
               <div  className='ml-[10px]'>   <p className="text-[#1D2228]  font-bold text-[16px] font-Lato font-sans mb-2">Storytelling and Narrative Design</p>
               <p  className='text-[14px] font-Regular font-Lato font-sans mb-2'>Crafting compelling stories and narratives<br></br> to enhance player engagement.</p></div>
              ...
              <div className="w-full ">
               ...
               <div  className='ml-[10px]'>   <p className="text-[#1D2228]  font-bold text-[16px] font-Lato font-sans mb-2">Level Design and World Building</p>
               <p  className='text-[14px] font-Regular font-Lato font-sans mb-2'>Designing levels and building immersive<br></br>game worlds for players.</p></div>
              ...
              <div className="w-full ">
               ...
               <div  className='ml-[10px]'>   <p className="text-[#1D2228]  font-bold text-[16px] font-Lato font-sans mb-2">Character Design and Animation</p>
               <p  className='text-[14px] font-Regular font-Lato font-sans mb-2'>Creating and animating characters<br></br> to bring games to life..</p></div>
               
              </div>
              <div className="w-full ">
                <div>  <img src={development} alt="Mobile Development" className="w-[284px] h-[181px] rounded-sm mb-2"/>
                </div>
               <div  className='ml-[10px]'>   <p className="text-[#1D2228]  font-bold text-[16px] font-Lato font-sans mb-2">User Experience (UX) in Games</p>
               <p  className='text-[14px] font-Regular font-Lato font-sans mb-2'>Ensuring a seamless and enjoyable player<br></br> experience through UX design..</p></div>
