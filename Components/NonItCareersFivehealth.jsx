...
export default function NonItCareersFivehealth () {
  return (
    ...
    <div className="bg-white p-4 border-r border-0 border-orange-500">
      ...
      <ul className="list-none text-[#1D2228] ">
        ...
        <li className="mb-2 text-[22px] font-medium font-Lato font-sans "> Mechanical Engineering</li>
          ...
          <li className="mb-2 text-[22px] font-medium font-Lato font-sans text-[#F27329] ">Health Care</li>
          <li className="mb-2 text-[22px] font-medium font-Lato font-sans border-b-2 w-[120px] border-black">Medical Coding</li>
          <li className="mb-2 text-[22px] font-medium font-Lato font-sans border-b-2 w-[120px] border-black">Health Information</li>
          <li className="mb-2 text-[22px] font-medium font-Lato font-sans ">Nursing skills</li>
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    Start Your Skill-Building Path with
      <span className="text-[#F27329]">Health Care Courses</span>
    </h2>
    <div className="bg-white p-2">
      ...
      Medical Coding involves translating healthcare diagnoses, procedures, and services into standardized codes for billing and documentation.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Introduction to Medical Coding</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Overview of medical coding principles and its importance in healthcare.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">ICD-10-CM Coding</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Understanding and applying the International Classification of Diseases, 10th Revision.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">CPT Coding</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Learning Current Procedural Terminology for documenting medical procedures and services.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">HCPCS Coding</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Utilizing the Healthcare Common Procedure Coding System for billing and reimbursement.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Medical Terminology</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Mastering the language of medicine to accurately interpret and code diagnoses.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Anatomy and Physiology</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Studying human body systems and functions to ensure precise coding.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Coding Guidelines and Compliance</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Adhering to coding standards, regulations, and ethical practices.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Claims Processing</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Understanding the medical billing cycle and the submission of coded claims.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Auditing and Quality Control</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Techniques for reviewing and ensuring the accuracy of medical coding.
            </p>
          </div>
        </div>
      </div>
