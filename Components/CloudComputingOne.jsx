...
function CloudComputingOne () {
    ...
    <div className="bg-white p-4 border-r border-0 border-orange-500">
      ...
      <ul className="list-none text-[#1D2228] pl-4">
        ...
        <div className='list-disc pl-4'>
          ...
          <li className="mb-2 text-[16px] font-medium font-Lato font-sans   border-b-2 w-[220px] border-black">Google Cloud</li>
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    <div className="bg-white p-2">
      ...
      aster Google Cloud Platform for innovative, scalable, and secure cloud solutions.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Introduction to Google Cloud Platform</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Overview of Google Cloud services, benefits, and core cloud concepts.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Google Cloud Console</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Navigating and using the Google Cloud Console for service management.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Compute Engine and Virtual Machines</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Setting up and managing virtual machines with Google Compute Engine.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Google Cloud Storage</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Storing and managing data using Google Cloud Storage.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Google VPC Networking</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Google Cloud IAM and Security</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Google Cloud Functions and Serverless</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Building and deploying serverless applications using Google Cloud Functions.
            </p>
          </div>
        </div>
      </div>
...
export default CloudComputingOne;
