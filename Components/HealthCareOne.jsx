...
export default function HealthcareOne() {
  return (
  ...
  <div className="w-1/4 pr-4 mt-[70px]">
    <div className="bg-white p-4 border-r border-0 border-orange-500">
     ...
     <li className="mb-2 text-[16px] font-medium font-Lato font-sans ">Medical Coding</li>
          <li className="mb-2 text-[16px] font-medium font-Lato font-sans border-b-2 w-[180px] border-black">Health Information</li>
          <li className="mb-2 text-[16px] font-medium font-Lato font-sans ">Nursing skills</li>
     </div>
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    <div className="bg-white p-2">
      ...
      Master the art of gathering, analyzing, and managing health data for improved decision-making.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Health Data Collection</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Gather accurate, relevant, and complete health information.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Data Management & Storage</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Organize, protect, and access health data efficiently.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Data Analysis & Interpretation</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Health Information Systems</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Utilize technology for data management and access.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Health Informatics</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Apply IT to improve healthcare delivery and outcomes.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Data Privacy & Security</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Safeguard patient information, comply with regulations.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Health Information Communication</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Effectively convey data-driven insights to stakeholders.
            </p>
          </div>
        </div>
