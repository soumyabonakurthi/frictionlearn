...
import sectiontwothree from '../assets/sectionttwotwo.png';
          ...
          <div className="flex items-center bg-white bg-opacity-75 rounded-md w-[402px] h-[62px] ml-[10px] mt-[20px]">
            <ul className="flex justify-between gap-5 search">
              <li className="text-[#1D2228] text-[18px] font-bold ml-[20px] my-[28px] flex">
                Courses <img src={arr} alt="" className="w-[11.13px] h-[7.13px] ml-[10px] mt-[10px]" />
              </li>
              <li className="text-[#1D2228] text-[18px] font-bold mr-[10px] ml-[10px] my-[28px]">Communities</li>
              <li className="text-[#1D2228] text-[18px] font-bold my-[28px]">Incubation</li>
...
<div className="flex justify-end mt-5   ml-[30px]  w-[529px]  ">
  ...
  {/* <button className="ml-4 px-4 py-2 bg-blue-600 text-white rounded-md">Join Community</button> */}
     ...
     <div   className="w-[1033px] h-[230px] flex flex-col  justify-center text-center  mt-[150px] mx-[204px] mb-[245px]">
         <h1     className=" text-[60px] w-[1033px] h-[170px] mb-[27px]  text-[#FFFFFF] font-black  font-sans font-lato">Be Part of Something Bigger to<br></br> Achieve More</h1>
          <h3   className=" text-[35px] w-[1033px] h-[170px]  text-[#FFFFFF] font-semibold  font-sans font-lato" >Join our community to connect, learn, and grow together.</h3>

     </div>

<div  className="flex flex-row align-middle justify-center"> <button   className="mt-[-120px] text-[22px] w-[210px] h-[56px] bg-[#F27329] text-[#FFFFFF] font-bold  font-sans font-lato" >Join Community</button></div>
