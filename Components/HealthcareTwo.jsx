...
export default function HealthcareTwo() {
  return (
  ...
  <div className="w-1/4 pr-4 mt-[70px]">
    <div className="bg-white p-4 border-r border-0 border-orange-500">
     ...
     <li className="mb-2 text-[16px] font-medium font-Lato font-sans ">Medical Coding</li>
          <li className="mb-2 text-[16px] font-medium font-Lato font-sans ">Health Information</li>
          <li className="mb-2 text-[16px] font-medium font-Lato font-sans border-b-2 w-[180px] border-black">Nursing skills</li>
     </div>
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    <div className="bg-white p-2">
      ...
      Master essential nursing techniques and patient care for exceptional healthcare delivery.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Patient Assessment</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Gather data, identify needs, develop care plans..
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Medication Administration</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Calculate dosages, administer safely, monitor effects.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Wound Care & Dressing</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Clean, dress wounds, promote healing, prevent infection.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Vital Signs Monitoring</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Measure blood pressure, temperature, pulse, respirations.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Infection Prevention & Control</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Break the chain of infection, practice asepsis.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Basic Life Support</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Perform CPR, use AED, manage airway obstruction.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Patient Communication & Education</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Listen actively, provide information, empower patients.
            </p>
          </div>
        </div>
