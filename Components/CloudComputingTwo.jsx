...
function CloudComputingTwo () {
    ...
    <div className="bg-white p-4 border-r border-0 border-orange-500">
      ...
      <ul className="list-none text-[#1D2228] pl-4">
        ...
        <div className='list-disc pl-4'>
          ...
          <li className="mb-2 text-[16px] font-medium font-Lato font-sans  "> AWS</li>
          <li className="mb-2 text-[16px] font-medium font-Lato font-sans   ">Google Cloud</li>
          <li className="mb-2 text-[16px] font-medium font-Lato font-sans  border-b-2 w-[220px] border-black ">Microsoft Azure</li>
        </div>
      </ul>
    </div>
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    <div className="bg-white p-2">
      ...
      Harness Microsoft Azure for comprehensive, flexible, and enterprise-grade cloud solutions.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Introduction to Microsoft Azure</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
                Overview of Azure services, cloud computing benefits, and core concepts.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Azure Portal and Management</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Navigating and using the Azure Portal for efficient service management.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Azure Virtual Machines</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Setting up and managing virtual machines with Azure Virtual Machines.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Azure Storage Solutions</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Storing and managing data using Azure Storage services.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Azure Virtual Network (VNet)</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Configuring and managing virtual networks for secure networking in Azure.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Azure Identity and Access Management (IAM)</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Implementing security practices and managing identities with Azure IAM.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Azure Functions and Serverless Computing</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Building and deploying serverless applications using Azure Functions.
            </p>
          </div>
        </div>
      </div>
