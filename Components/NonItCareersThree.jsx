...
export default function NonItCareersThree () {
  return (
    ...
    <div className="bg-white p-4 border-r border-0 border-orange-500">
      ...
      <ul className="list-none text-[#1D2228] ">
        ...
        <li className="mb-2 text-[22px] font-medium font-Lato font-sans "> Mechanical Engineering</li>
          ...
          <li className="mb-2 text-[22px] font-medium font-Lato font-sans text-[#F27329] ">ECE</li>
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    Start Your Skill-Building Path with
      <span className="text-[#F27329]">  ECE Course</span>
    </h2>
    <div className="bg-white p-2">
      ...
      ECE focuses on designing, developing, and maintaining electronic systems and communication networks.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Introduction to ECE</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Overview of electronics and communication engineering principles and applications.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Digital Electronics</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Studying digital circuits, logic gates, and binary systems.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Analog Electronics</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Understanding analog circuits, components, and signal processing.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Microprocessors and Microcontrollers</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Learning about microprocessor architecture and programming microcontrollers.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Communication Systems</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Exploring the principles and technologies behind communication systems.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Signal Processing</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Techniques for analyzing and processing signals in various applications.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">VLSI Design</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Designing and developing very-large-scale integration (VLSI) circuits.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Embedded Systems</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Integrating hardware and software for specific functionalities in systems.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Wireless Communication</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Understanding the principles and technologies of wireless communication networks.
            </p>
          </div>
        </div>
      </div>
