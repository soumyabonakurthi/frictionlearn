...
function NonItCareers () {
  ...
  <div className="w-1/4 pr-4 mt-[70px]">
    <div className="bg-white p-4 border-r border-0 border-orange-500">
      ...
      <ul className="list-none text-[#1D2228] ">
        ...
        <li className="mb-2 text-[22px] font-medium font-Lato font-sans text-[#F27329] "> Mechanical Engineering</li>
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    Start Your Skill-Building Path with
      <span className="text-[#F27329]">  Mechanical Engineering Course</span>
    </h2>
    <div className="bg-white p-2">
      ...
      Mechanical Engineering focuses on designing, analyzing, and manufacturing mechanical systems and devices.-
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Introduction to Mechanical Engineering</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Overview of mechanical engineering principles and their real-world applications.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Thermodynamics</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Studying the principles of energy, heat, and work in systems.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Fluid Mechanics</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Analyzing the behavior and movement of fluids in various applications.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Material Science</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Understanding the properties and applications of different engineering materials.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Solid Mechanics</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Examining the behavior of solid materials under various forces.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Mechanical Design</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Principles and processes for designing mechanical components and systems.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Manufacturing Processes</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Exploring techniques and methods used in manufacturing mechanical parts.
            </p>
          </div>
        </div>
      </div>
