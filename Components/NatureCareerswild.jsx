...
export default function NatureCareerswild () {
  return (
  ...
  <div className="w-1/4 pr-4 mt-[70px]">
    <div className="bg-white p-4 border-r border-0 border-orange-500">
     ...
     <li className="mb-2 text-[16px] font-medium font-Lato font-sans ">AgriTech Innovations</li>
          ...
          <div  className='pl-8 list-disc mb-[18px]'>
     <li className="mb-2 text-[16px] font-medium font-Lato font-sans  border-b-2 w-[180px] border-black">Conservation Biology</li>
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    <div className="bg-white p-2">
      ...
      Conservation Biology focuses on protecting biodiversity and preserving natural ecosystems.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Biodiversity Assessment</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Measuring species diversity and ecosystem health for conservation planning.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Endangered Species</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Strategies for protecting and rehabilitating threatened and endangered species.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Habitat Restoration</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Rebuilding and restoring natural habitats to support wildlife populations.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Conservation Genetics</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Using genetic research to maintain and enhance species diversity.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Invasive Species Management</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Controlling and mitigating the impact of non-native species on ecosystems.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Conservation Policy</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Developing and implementing policies for sustainable environmental protection.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Community Engagement</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Involving local communities in conservation efforts and education.
            </p>
          </div>
        </div> 
      </div>
