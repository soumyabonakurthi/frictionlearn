...
export default function NatureCareersEnvOne () {
  return (
  ...
  <div className="w-1/4 pr-4 mt-[70px]">
    <div className="bg-white p-4 border-r border-0 border-orange-500">
     ...
     <li className="mb-2 text-[16px] font-medium font-Lato font-sans border-b-2 w-[180px] border-black">Environmental Impact</li>
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    <div className="bg-white p-2">
      ...
      Environmental Impact examines how human activities affect natural ecosystems and resources.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Pollution Sources</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Identify and analyze major sources of air, water, and soil pollution.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Deforestation Effects</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Impact of forest loss on biodiversity, climate, and human health.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Habitat Destruction</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Consequences of urbanization, agriculture, and industry on wildlife.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Waste Management</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Techniques for reducing, reusing, and recycling waste materials.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Water Resources</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Assessing the effects of pollution and overuse on water availability.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Air Quality</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Understanding pollutants and their impact on human and environmental health.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Sustainable Practices</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Implementing eco-friendly methods to minimize environmental damage.
            </p>
          </div>
        </div>
