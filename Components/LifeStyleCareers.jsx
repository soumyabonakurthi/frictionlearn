...
export default function LifeStyleCareers() {
  return (
  ...
  <div className="w-1/4 pr-4 mt-[70px]">
    <div className="bg-white p-4 border-r border-0 border-orange-500">
      ...
      <ul className="list-none text-[#1D2228] ">
        ...
        <li className="mb-2 text-[22px] font-medium font-Lato font-sans text-[#F27329] "> Health & Wellness</li>
  ...
  <div className="w-3/4 pl-2 mt-[76px]">
    ...
    Start Your Skill-Building Path with
      <span className="text-[#F27329]"> Health & Wellness Course</span>
    </h2>
    <div className="bg-white p-2">
      ...
      Empower yourself with knowledge and tools to achieve optimal physical, mental, and emotional well-being.
      </p>
      <div className="grid grid-cols-3 gap-[32px]">
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Nutrition and Diet</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Balance macronutrients, choose whole foods, optimize energy levels.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Physical Fitness</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Exercise regularly, build strength, improve cardiovascular health.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Mental Health and Well-being</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Manage stress, boost mood, enhance emotional intelligence.
            </p>
          </div>
        </div>
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Sleep and Rest</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Prioritize sleep, improve focus, enhance cognitive function.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Stress Management</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Reduce anxiety, improve resilience, find relaxation techniques.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Chronic Disease Prevention</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Identify risks, make lifestyle changes, protect your future.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Weight Management</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Achieve healthy weight, boost confidence, improve overall health.
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Healthy Relationships</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Build strong bonds, effective communication, emotional support..
            </p>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className='ml-[10px]'>
            <p className="text-[#1D2228] font-bold text-[16px] font-Lato font-sans mb-2">Holistic Wellnessg</p>
            <p className='text-[14px] font-Regular font-Lato font-sans mb-2'>
            Mind-body connection, balance lifestyle, achieve optimal well-being.
            </p>
          </div>
        </div>
      </div>
